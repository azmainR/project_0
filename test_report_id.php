...
function fetch_data()
{
    ...
    if (isset($emp_id1) && isset($emp_id2)) {
        $sql3 = $sql3 . " and e.manager_id between $emp_id1 and $emp_id2";
    }
    $sql3 = $sql3 . " order by f.employee_id asc";
    // and
    // e.manager_id between '$emp_id1' and '$emp_id2' 
